...
<div class="form-group row">
	...
	<div class="col-sm-10">
		<input type="text" name="email" class="form-control <?php echo ($error_email !="" ? "is-invalid" : ""); ?>" id="email" placeholder="Email" value="<?php echo $nama; ?>"><span class="warning"><?php echo $error_email; ?></span>
	</div>	
	</div>
<div class="form-group row">
	<label for="web" class="col-sm-2 col-form-label">Websitel</label>
	<div class="col-sm-10">
	...
	<div class="form-group row">
	<label for="pesan" class="col-sm-2 col-form-label">Telp</label>
	<div class="col-sm-10">
